...
const ParcelDetails = () => {
  ...
  return (
    <div>
      <div className="overflow-x-auto ml-7 rounded-box border border-base-content/5 ">
        <div className="space-y-5">
          {data?.data.map((item) => (
            <div
              key={item._id}
              className="border rounded-lg p-4 bg-base-100 shadow"
            >
              {/* Main Box */}
              <div className="flex justify-between items-center pb-3">
                <h2 className="font-bold mb-3">
                  Parcel Name: {item.parcelName}
                </h2>
              ...
              <div className="mt-3 text-sm">
                ...
                <div className="flex gap-2.5 items-center">
                  ...
                  <Link
                    ...
                    className="bg-primary px-3.5 py-2 text-white font-bold rounded-md cursor-pointer"
                  >
                    Pays
                  </Link>
                </div>
